    ...
    public void run() {
        try {
            ...
            if (isDuplicateMessage(mContext, retrieveConf)) {
                ...
                //if(persister==null) Log.i("","persister is null");;
                //if(com.klinker.android.send_message.Transaction.settings==null) Log.i("","com.klinker.android.send_message.Transaction.settings is null");
                boolean group;
